...
struct iOSImagePicker: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<iOSImagePicker>) -> UIImagePickerController {
    ...
    func updateUIViewController(_ uiViewController: UIImagePickerController, context: UIViewControllerRepresentableContext<iOSImagePicker>) {}
